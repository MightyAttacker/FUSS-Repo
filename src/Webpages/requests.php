...
<body>
  ...
  <div id="sideBar">
    ...
    <main>
      <div id="Header">
        <h2> <Button onclick="showInbox()" class="button">Incoming Requests</Button> <Button class="button"
            onclick="showMessage()">Send Request</Button> <Button onclick="showOutbox()" class="button">Sent
            Requests</Button> </h2>
      </div>
      ...
      <div id="sendMessage">
        ...
        <form action="requestSend.php" method="post" id="messageForm">
          ...
          <select class="selectBox" id="user" name="user" onclick="">
          <?php
          ...
          ?>
            ...
            <div class="form-section">
              ...
              <select class="selectBox" id="skillName" name="skillName" class="addList" onclick="">

                <!-- Fetch all skills from skills table -->
                <?php
                $getAcademicListStmt = $conn->prepare('SELECT skillName FROM skills ORDER BY skillName ASC');
            ...
            <div class="form-section">
              ...
              <input class="form-item" type="number" id="creditsOffered" name="creditsOffered" min="1"
                max="<?php echo $userCredits ?>" required><br>
              <div class="form-section">
                <label for="sendMessage">Message:</label><span id="charNum"></span>
                <br>
                <textarea id="messageArea" name="message" rows="4" cols="50" maxlength="255"
                  onkeyup="limitText(this,255)" required></textarea>
                <br>
              </div>
              <div class="form-section">
                <label for="proposedDateTime"> Proposed Date and Time:</label><br>
                <input class="form-item" type="datetime-local" id="proposedDateTime" name="proposedDateTime"
                  required><br>
