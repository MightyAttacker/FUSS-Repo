...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2025 at 09:15 AM
...
INSERT INTO `userdata` (`id`, `email`, `firstName`, `lastName`, `password`, `imageName`, `imagePath`, `academicYear`, `credits`, `college`, `bio`, `admin`) VALUES
(1, 'putl0014@flinders.edu.au', 'Jayden', 'Putland', '$2y$10$ds4ha4PtWZZZ2Xk9G.4pRuKwAcJSeKQczEOYZDqMIjimGrtasegtG', 'Daschund stock image.jpg', '..\\userProfilePictures\\Daschund stock image.jpg', 2, 10, 'Information Science', 'Im a explodey mcboomy', 1),
(2, 'bob@flinders.edu.au', 'Bob', 'Test', '$2y$10$FhUF0v/ZyEzPw6GLdOuwEONmeEuBpzZxrFQ8VqGk6JJuytP.G.RQ6', '', '', 0, 0, '', '', 1),
(3, 'test@flinders.edu.au', 'First', 'Last', '$2y$10$mmiNWdOSqK0HWZaRtcNHe.yjyoB3khBe.Ickx8DG3Rs4mrYIwj1r6', '', '', 0, 0, '', '', 0);
